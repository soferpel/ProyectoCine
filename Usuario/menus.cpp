...
void menuModificarUsuario()
{
    ...
    cout << "===================" << endl;
    cout << endl;
    cout << "AVISO: Solo puedes cambiar el nombre y la respuesta del usuario" << endl;
    cout << "Introduce el correo electronico del usuario a modificar: ";
    cin >> correoNuevo;
    usuario.setCorreo(correoNuevo);
    cout << "Introduce la contrasena del usuario a modificar: ";
    cin >> contrasena;
    usuario.setContrasena(contrasena);
    cout << "Introduce el nuevo nombre del usuario: ";
    cin >> nombreUsuario;
    usuario.setNombre(nombreUsuario);
    cout << "Introduce la nueva respuesta de seguridad (Cual es tu pelicula favorita?) del usuario: ";
    cin >> respuestaSeguridad;
    usuario.setRespuesta(respuestaSeguridad);
    cout << endl;
    char c; while ((c = getchar()) != '\n' && c != EOF);
